...
# =============================================================================
# Legacy AdGuard Infrastructure (Commented out for Vault-Only Testing)
# =============================================================================
# Uncomment these resources when deploying full infrastructure
...
# Buckets (commented - no compartment)
...
# VCN (commented for vault-only testing)
